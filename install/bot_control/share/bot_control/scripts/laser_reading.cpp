// File: bot_control/scripts/reading_laser.cpp
...
private:
    void laser_callback(const sensor_msgs::msg::LaserScan::SharedPtr msg)
    {
        ...
        int total_ranges = filtered.ranges.size();
        double angle_increment = filtered.angle_increment;
        double start_angle = filtered.angle_min;

        // Only keep data from 0 to 120 degrees
        double lower_limit = 0.0;
        double upper_limit = 2.0 * M_PI / 3.0;  // 120 degrees in radians
